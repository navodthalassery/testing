...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Shiny.ActivityLifecycleCallbacks, Shiny.Core", ActivityLifecycleCallbacks.class, __md_methods);
	}
	...
	public ActivityLifecycleCallbacks ()
	{
		...
		if (getClass () == ActivityLifecycleCallbacks.class)
			mono.android.TypeManager.Activate ("Shiny.ActivityLifecycleCallbacks, Shiny.Core", "", this, new java.lang.Object[] {  });
	}
